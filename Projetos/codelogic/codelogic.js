...
function initializeRevealAnimations() {
    const revealElements = Array.from(document.querySelectorAll('.logic-reveal'));
    ...
    revealElements.forEach((element, index) => {
        ...
        element.style.setProperty('--logic-reveal-delay', `${delay}ms`);
    });
...
function initializeCodeLogicPage() {
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initializeCodeLogicPage);
} else {
    initializeCodeLogicPage();
}
